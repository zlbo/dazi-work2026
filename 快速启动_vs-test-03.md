...
```powershell
cd "项目\flow_<项目名>\流程\vs-test-03"

# 状态 / 拉取 / 提交
.\\scripts\\dazi.ps1 flow project status --dir .
.\\scripts\\dazi.ps1 flow project pull --flow 119 --dir .
...
4. 必要时重新拉取校对：`.\\scripts\\dazi.ps1 flow project pull --flow 119 --dir .`
