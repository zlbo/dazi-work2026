import { resolveStaticDatasetFromManifest } from "@dazi/app-sdk-data";
...
async function bootstrap() {
  const reportFromManifest = resolveStaticDatasetFromManifest(manifest, "report_data");
  const datasets = {
    ...fixtureDatasets,
    report_data: reportFromManifest ?? fixtureDatasets.report_data,
  };
