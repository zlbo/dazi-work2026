...
**流程**：test_flow0605a · 平台 flowId `128`
...
|------|-----|
| flowId | `128` |
| 本地目录 | `项目/潘达石化/流程/flows/test_flow0605a/` |
| 画布节点（flow.json） | 2，其中代码节点 0 |
| meta 已索引代码 | 0 |
| 上次拉取 | 2026-06-05T11:28:59.656Z |
...
```powershell
dazi flow project status --dir "d:\src2025\ads2025\dazi-work\项目\潘达石化\流程\flows\test_flow0605a"
dazi flow project pull --flow 128 --dir "d:\src2025\ads2025\dazi-work\项目\潘达石化\流程\flows\test_flow0605a"
dazi flow project push --dir "d:\src2025\ads2025\dazi-work\项目\潘达石化\流程\flows\test_flow0605a" --canvas
dazi flow node push --node <node_uuid> --dir "d:\src2025\ads2025\dazi-work\项目\潘达石化\流程\flows\test_flow0605a"
dazi flow run node-exec --node <node_uuid> --dir "d:\src2025\ads2025\dazi-work\项目\潘达石化\流程\flows\test_flow0605a"
dazi flow variable pull --name <output_variable_name> --dir "d:\src2025\ads2025\dazi-work\项目\潘达石化\流程\flows\test_flow0605a"
dazi flow run flow-exec --dir "d:\src2025\ads2025\dazi-work\项目\潘达石化\流程\flows\test_flow0605a" --type debug
dazi flow variable sync --dir "d:\src2025\ads2025\dazi-work\项目\潘达石化\流程\flows\test_flow0605a"
```
...
```powershell
cd "d:\src2025\ads2025\dazi-work\项目\潘达石化\流程\flows\test_flow0605a"
dazi flow project status --dir .
dazi flow project pull --flow 128 --dir .
```
...
dazi flow project pull --flow 128 --dir "<FLOW_DIR>"
...
4. 必要时重新拉取校对：`dazi flow project pull --flow 128 --dir .`
