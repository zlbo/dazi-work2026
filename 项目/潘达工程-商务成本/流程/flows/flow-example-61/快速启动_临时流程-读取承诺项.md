...
|------|-----|
| flowId | `61` |
| 本地目录 | `项目/潘达工程-商务成本/流程/flows/临时流程-读取承诺项/` |
| 画布节点（flow.json） | 3，其中代码节点 1 |
| meta 已索引代码 | 1 |
| 上次拉取 | 2026-06-06T07:39:42.716Z |
...
```powershell
dazi flow project status --dir "d:\GitHub\dazi-work\项目\潘达工程-商务成本\流程\flows\flow-example-61"
dazi flow project pull --flow 61 --dir "d:\GitHub\dazi-work\项目\潘达工程-商务成本\流程\flows\flow-example-61"
dazi flow project push --dir "d:\GitHub\dazi-work\项目\潘达工程-商务成本\流程\flows\flow-example-61" --canvas
dazi flow node push --node <node_uuid> --dir "d:\GitHub\dazi-work\项目\潘达工程-商务成本\流程\flows\flow-example-61"
dazi flow run node-exec --node <node_uuid> --dir "d:\GitHub\dazi-work\项目\潘达工程-商务成本\流程\flows\flow-example-61"
dazi flow variable pull --name <output_variable_name> --dir "d:\GitHub\dazi-work\项目\潘达工程-商务成本\流程\flows\flow-example-61"
dazi flow run flow-exec --dir "d:\GitHub\dazi-work\项目\潘达工程-商务成本\流程\flows\flow-example-61" --type debug
dazi flow variable sync --dir "d:\GitHub\dazi-work\项目\潘达工程-商务成本\流程\flows\flow-example-61"
```
...
```powershell
cd "d:\GitHub\dazi-work\项目\潘达工程-商务成本\流程\flows\flow-example-61"
dazi flow project status --dir .
dazi flow project pull --flow 61 --dir .
```
...
dazi flow project pull --flow 61 --dir "<FLOW_DIR>"
...
4. 必要时重新拉取校对：`dazi flow project pull --flow 61 --dir .`
