...
|------|-----|
| flowId | `63` |
| 本地目录 | `项目/潘达工程-商务成本/流程/flows/利润成本分析/` |
| 画布节点（flow.json） | 12，其中代码节点 10 |
| meta 已索引代码 | 10 |
| 上次拉取 | 2026-06-06T07:35:31.812Z |
...
```powershell
dazi flow project status --dir "d:\GitHub\dazi-work\项目\潘达工程-商务成本\流程\flows\flow-example"
dazi flow project pull --flow 63 --dir "d:\GitHub\dazi-work\项目\潘达工程-商务成本\流程\flows\flow-example"
dazi flow project push --dir "d:\GitHub\dazi-work\项目\潘达工程-商务成本\流程\flows\flow-example" --canvas
dazi flow node push --node <node_uuid> --dir "d:\GitHub\dazi-work\项目\潘达工程-商务成本\流程\flows\flow-example"
dazi flow run node-exec --node <node_uuid> --dir "d:\GitHub\dazi-work\项目\潘达工程-商务成本\流程\flows\flow-example"
dazi flow variable pull --name <output_variable_name> --dir "d:\GitHub\dazi-work\项目\潘达工程-商务成本\流程\flows\flow-example"
dazi flow run flow-exec --dir "d:\GitHub\dazi-work\项目\潘达工程-商务成本\流程\flows\flow-example" --type debug
dazi flow variable sync --dir "d:\GitHub\dazi-work\项目\潘达工程-商务成本\流程\flows\flow-example"
```
...
```powershell
cd "d:\GitHub\dazi-work\项目\潘达工程-商务成本\流程\flows\flow-example"
dazi flow project status --dir .
dazi flow project pull --flow 63 --dir .
```
...
dazi flow project pull --flow 63 --dir "<FLOW_DIR>"
...
4. 必要时重新拉取校对：`dazi flow project pull --flow 63 --dir .`
