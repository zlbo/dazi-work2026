"""环比分析 panda_cost.fn.mom_analysis
...
发布：
  dazi onto script publish 项目/潘达工程-商务成本/本体/ontos/本体规划02/functions/panda_cost_fn_mom_analysis.py \
...
def _ontology_fn_body(p):
    ...
    data = [{
        ...
        "previous_month_value": round(previous_value, 4),
