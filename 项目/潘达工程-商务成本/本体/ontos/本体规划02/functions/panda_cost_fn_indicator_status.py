"""核心指标达成与预警 panda_cost.fn.indicator_status
...
发布：
  dazi onto script publish 项目/潘达工程-商务成本/本体/ontos/本体规划02/functions/panda_cost_fn_indicator_status.py \
...
def _ontology_fn_body(p):
    ...
    data = []
    for row in rows:
        indicator_value = float(row.get("indicator_value") or 0)
