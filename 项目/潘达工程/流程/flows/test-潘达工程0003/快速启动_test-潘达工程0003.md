...
**流程**：test-潘达工程0003 · 平台 flowId `129`
...
|------|-----|
| flowId | `129` |
| 本地目录 | `项目/潘达工程/流程/flows/test-潘达工程0003/` |
| 画布节点（flow.json） | 2，其中代码节点 0 |
| meta 已索引代码 | 0 |
| 上次拉取 | 2026-06-05T12:48:28.995Z |
...
```powershell
dazi flow project status --dir "d:\GitHub\dazi-work\项目\潘达工程\流程\flows\test-潘达工程0003"
dazi flow project pull --flow 129 --dir "d:\GitHub\dazi-work\项目\潘达工程\流程\flows\test-潘达工程0003"
dazi flow project push --dir "d:\GitHub\dazi-work\项目\潘达工程\流程\flows\test-潘达工程0003" --canvas
dazi flow node push --node <node_uuid> --dir "d:\GitHub\dazi-work\项目\潘达工程\流程\flows\test-潘达工程0003"
dazi flow run node-exec --node <node_uuid> --dir "d:\GitHub\dazi-work\项目\潘达工程\流程\flows\test-潘达工程0003"
dazi flow variable pull --name <output_variable_name> --dir "d:\GitHub\dazi-work\项目\潘达工程\流程\flows\test-潘达工程0003"
dazi flow run flow-exec --dir "d:\GitHub\dazi-work\项目\潘达工程\流程\flows\test-潘达工程0003" --type debug
dazi flow variable sync --dir "d:\GitHub\dazi-work\项目\潘达工程\流程\flows\test-潘达工程0003"
```
...
```powershell
cd "d:\GitHub\dazi-work\项目\潘达工程\流程\flows\test-潘达工程0003"
dazi flow project status --dir .
dazi flow project pull --flow 129 --dir .
```
...
dazi flow project pull --flow 129 --dir "<FLOW_DIR>"
...
4. 必要时重新拉取校对：`dazi flow project pull --flow 129 --dir .`
