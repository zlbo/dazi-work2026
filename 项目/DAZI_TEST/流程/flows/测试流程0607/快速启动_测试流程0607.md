...
|------|-----|
| flowId | `131` |
| 本地目录 | `项目/DAZI_TEST/流程/flows/测试流程0607/` |
| 画布节点（flow.json） | 2，其中代码节点 0 |
| meta 已索引代码 | 0 |
| 上次拉取 | 2026-06-07T01:04:45.527Z |
...
```powershell
dazi flow project status --dir "d:\src2025\ads2025\dazi-work\项目\DAZI_TEST\流程\flows\测试流程0607"
dazi flow project pull --flow 131 --dir "d:\src2025\ads2025\dazi-work\项目\DAZI_TEST\流程\flows\测试流程0607"
dazi flow project push --dir "d:\src2025\ads2025\dazi-work\项目\DAZI_TEST\流程\flows\测试流程0607" --canvas
dazi flow node push --node <node_uuid> --dir "d:\src2025\ads2025\dazi-work\项目\DAZI_TEST\流程\flows\测试流程0607"
dazi flow run node-exec --node <node_uuid> --dir "d:\src2025\ads2025\dazi-work\项目\DAZI_TEST\流程\flows\测试流程0607"
dazi flow variable pull --name <output_variable_name> --dir "d:\src2025\ads2025\dazi-work\项目\DAZI_TEST\流程\flows\测试流程0607"
dazi flow run flow-exec --dir "d:\src2025\ads2025\dazi-work\项目\DAZI_TEST\流程\flows\测试流程0607" --type debug
dazi flow variable sync --dir "d:\src2025\ads2025\dazi-work\项目\DAZI_TEST\流程\flows\测试流程0607"
```
...
```powershell
cd "d:\src2025\ads2025\dazi-work\项目\DAZI_TEST\流程\flows\测试流程0607"
dazi flow project status --dir .
dazi flow project pull --flow 131 --dir .
```
...
dazi flow project pull --flow 131 --dir "<FLOW_DIR>"
...
4. 必要时重新拉取校对：`dazi flow project pull --flow 131 --dir .`
