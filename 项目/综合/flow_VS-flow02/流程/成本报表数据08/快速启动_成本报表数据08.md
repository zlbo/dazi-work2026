...
| flowId | `113` |
| 本地目录 | `流程/成本报表数据08/` |
| 画布节点（flow.json） | 4，其中代码节点 1 |
| meta 已索引代码 | 1 |
| 上次拉取 | 2026-06-04T00:33:03.807Z |
...
```powershell
cd "项目\flow_VS-flow02\流程\成本报表数据08"

# 状态 / 拉取 / 提交
dazi flow project status --dir .
dazi flow project pull --flow 113 --dir .
...
4. 必要时重新拉取校对：`dazi flow project pull --flow 113 --dir .`
