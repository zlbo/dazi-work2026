...
|------|-----|
| flowId | `114` |
| 本地目录 | `流程/test06030002/` |
| 节点数 | 4（代码节点 2） |
| 上次拉取 | 2026-06-03T13:33:46.215Z |
...
```powershell
cd "项目\flow_DEMO_102_Flows\流程\test06030002"

# 状态 / 拉取 / 提交
.\scripts\dazi.ps1 flow project status --dir .
.\scripts\dazi.ps1 flow project pull --flow 114 --dir .
