...
dazi app init financial-indicators-complex-report --space space__0519 --dir 项目/app_<名>/apps/my-fin-report-001
```
...
3. `pnpm run build` → `dazi app upload --cwd 项目/app_<名>/apps/<app_id> --activate`（在 dazi-work 根）
