...
**流程**：excel_flow_01 · 平台 flowId `107`
...
|------|-----|
| flowId | `107` |
| 本地目录 | `流程/excel_flow_01/` |
| 节点数 | 4（代码节点 2） |
| 上次拉取 | 2026-06-01T00:27:43.702Z |
...
```powershell
cd "项目\flow_流程项目02\流程\excel_flow_01"

# 状态 / 拉取 / 提交
.\scripts\dazi.ps1 flow project status --dir .
.\scripts\dazi.ps1 flow project pull --flow 107 --dir .
