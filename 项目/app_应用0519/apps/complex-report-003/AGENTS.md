# complex-report-003（`complex-report-003`）· 应用 AI 上下文
...
| 项 | 值 |
|----|-----|
| app_id | `complex-report-003` |
| 空间 | `space__0519` |
| 模板 | `chinese-complex-report` |
| 目录 | `D:/src2025/ads2025/dazi-work/项目/app_应用0519/apps/complex-report-003` |
