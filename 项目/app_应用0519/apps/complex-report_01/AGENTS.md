# complex_report_01（`complex-report_01`）· 应用 AI 上下文
...
| 项 | 值 |
|----|-----|
| app_id | `complex-report_01` |
| 空间 | `space__0519` |
| 模板 | `chinese-complex-report` |
| 目录 | `D:/src2025/ads2025/dazi-work/项目/app_应用0519/apps/complex-report_01` |
