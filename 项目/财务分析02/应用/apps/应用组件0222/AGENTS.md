# 应用组件0222（`alarm-center-20260605104837`）· 应用 AI 上下文
...
| 项 | 值 |
|----|-----|
| app_id | `alarm-center-20260605104837` |
| 空间 | `space__misc_01` |
| 模板 | `alarm-center` |
| 目录 | `D:/src2025/ads2025/dazi-work/项目/财务分析02/应用/apps/应用组件0222` |
...
dazi app manifest validate --cwd 项目/财务分析02/应用/apps/应用组件0222 --scan-src
dazi app doctor --cwd 项目/财务分析02/应用/apps/应用组件0222
dazi app upload --cwd 项目/财务分析02/应用/apps/应用组件0222 --space space__misc_01 --activate
```
