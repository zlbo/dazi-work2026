...
|------|-----|
| flowId | `127` |
| 本地目录 | `项目/财务分析02/流程/flows/财务流程04/` |
| 画布节点（flow.json） | 2，其中代码节点 0 |
| meta 已索引代码 | 0 |
| 上次拉取 | 2026-06-05T06:43:31.812Z |
...
```powershell
dazi flow project status --dir "d:\src2025\ads2025\dazi-work\项目\财务分析02\流程\flows\财务流程04"
dazi flow project pull --flow 127 --dir "d:\src2025\ads2025\dazi-work\项目\财务分析02\流程\flows\财务流程04"
dazi flow project push --dir "d:\src2025\ads2025\dazi-work\项目\财务分析02\流程\flows\财务流程04" --canvas
dazi flow run node-exec --node <node_uuid> --dir "d:\src2025\ads2025\dazi-work\项目\财务分析02\流程\flows\财务流程04"
dazi flow run flow-exec --dir "d:\src2025\ads2025\dazi-work\项目\财务分析02\流程\flows\财务流程04" --type debug
dazi flow variable sync --dir "d:\src2025\ads2025\dazi-work\项目\财务分析02\流程\flows\财务流程04"
```
...
```powershell
cd "d:\src2025\ads2025\dazi-work\项目\财务分析02\流程\flows\财务流程04"
dazi flow project status --dir .
dazi flow project pull --flow 127 --dir .
```
...
dazi flow project pull --flow 127 --dir "<FLOW_DIR>"
...
4. 必要时重新拉取校对：`dazi flow project pull --flow 127 --dir .`
