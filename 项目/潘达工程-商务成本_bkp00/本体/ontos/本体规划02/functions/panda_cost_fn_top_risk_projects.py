"""高风险项目 Top N panda_cost.fn.top_risk_projects

参数：report_period, limit
返回：rank, project_id, project_name, risk_score, high_risk_count, warning_level, report_period

发布：
  dazi onto script publish 项目/潘达工程-商务成本/本体/ontos/本体规划02/functions/panda_cost_fn_top_risk_projects.py \
...
def _ontology_fn_body(p):
    ...
    SELECT
        ...
        countIf(r.warning_level IN ('red', '高')) AS high_risk_count,
